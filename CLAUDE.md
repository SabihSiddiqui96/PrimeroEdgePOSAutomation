...
| Repo | Required |
|---|---|
| SchoolCafe, POS, K12, ExpressPoint (Desktop + Mobile) | **Venkata Pranitha Raj Kondaveeti** |
| SCTV / CafeTV | **Prasoona Nalajala** |

The other three are optional on that PR — so Pranitha is optional on TV, and Prasoona
